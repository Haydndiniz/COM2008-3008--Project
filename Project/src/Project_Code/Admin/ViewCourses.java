...
public class ViewCourses extends JPanel implements ActionListener {
     ...
     */
    public ViewCourses(JFrame f, AdminMain admin) {
        ...
        JLabel label = new JLabel("Courses Table:");
        ...
        table.setModel(this.admin.viewAllCourses());
